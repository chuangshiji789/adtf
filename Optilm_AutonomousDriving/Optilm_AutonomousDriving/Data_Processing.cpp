...
//                LOG_INFO(adtf_util::cString::Format("Position  X=%f  Y=%f  ", position_data[X], position_data[Y]));
...
tResult cOptilm_AutonomousDriving::SetDigitialMapRegion()
{
    ...
    avoidance_section_boundary[0].left  = 6;
    ...
    pedestrian_section_boundary[0].left  = 10;
    pedestrian_section_boundary[0].right = 12;
    pedestrian_section_boundary[0].top   = 4.2;
    pedestrian_section_boundary[0].bom   = 2.8;


    pedestrian_section_boundary[1].left  = 2.644;
    pedestrian_section_boundary[1].right = 4.356;
    pedestrian_section_boundary[1].top   = 1.135;
    pedestrian_section_boundary[1].bom   = -0.135;

    pedestrian_nummer = 1;



    child_section_boundary[0].left  = 5;
    child_section_boundary[0].right = 6.5;
    child_section_boundary[0].top   = 1,2;
