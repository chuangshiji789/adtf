...
void L_Protection_MiddleBlock(ITS *iTS)
{
	...
	subBlock12_LaneDistance = (short)(abs(iTS->L_MiddleBlock_LaneBount_R - iTS->L_MiddleBlock_LaneBount_L) * 0.2);
	M_subBlock1_initial = iTS->F_W * (StartRow12 - 1) + (iTS->L_MiddleBlock_LaneBount_L + subBlock12_LaneDistance);

	subBlock34_LaneDistance = (short)(abs(iTS->L_MiddleBlock_LaneBount_R - iTS->L_MiddleBlock_LaneBount_L) * 0.4);
