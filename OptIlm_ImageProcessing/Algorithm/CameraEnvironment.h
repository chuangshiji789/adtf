...
#ifdef VEHICLE_A
#define S_IMGCH		232//234             //car A
#else
#define S_IMGCH		247          //car B
#endif

#define S_IMGLB		8//18
#define S_IMGRB		632//622
#define S_IMGTB		468
#define S_IMGBB		12

#define L_IB_TB_SearchLane                  180//210
#define L_IB_BB_SearchLane                  130
#define L_IB_TB_TrackingLane                200//205//210
#define L_IB_BB_TrackingLane                L_IB_BB_SearchLane
#define L_IB_TB_DrawLane                    200//180//168
#define L_IB_ThChangeOrder                  30//20//40//60//120
#define L_IP_MaintainInCtn_LossOneSide		20//10
#define L_IP_DetectedRowToUpdateLW          5//10
#define L_IP_DetectedRowSetROIwithLM		10//20
#define L_IP_DetectedRowPromoteToCtn		15//15//30
#define L_IP_LinePixelPromoteToCtn          10//3//10
...
#ifdef VEHICLE_A
#define EV_ROAD_SLOPE           0.388398     //640*480 no fischeye "Car A"
#else
#define EV_ROAD_SLOPE           -0.14567    //640*480 no fischeye "Car B"
#endif
...
//真實世界類
#define L_RW_ROILRegion 20    //15cm serach Roi  由總寬度最外邊往內多少距離
...
#define L_RW_MaxLWInLossOneSide 50//60//75   //650
#define L_RW_MinLWInLossOneSide 40//30   //270
#define L_RW_MinLWInSig 35//30           //220
...
#define L_PW_ReserveLaneModel 1.8//4.6//3.8//5.2//1.8
